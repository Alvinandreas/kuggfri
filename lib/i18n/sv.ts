...
export const sv = {
  ...
  auth: {
    ...
    forgotHint: "Glömt lösenordet? Logga in med länk och välj ett nytt under Konto.",
  ...
  admin: {
    ...
    tileActiveSub: (n: number) => (n === 1 ? "1 student" : `${n} studenter`),
    tileReviews: "Repetitioner",
    tileReviewsSub: "senaste 14 dagarna",
    tileReports: "Öppna felrapporter",
    tileReportsSub: "från studenter",
    overviewRadar: "Kunskap per kategori",
    overviewRadarHelp: "Genomsnittlig andel inlärda och delvis inlärda kort per student.",
    perCategory: "Per kategori",
    perCategoryHelp: "Hur långt en genomsnittlig student kommit i varje kategori.",
    colCategory: "Kategori",
    colStudents: "Studenter",
    colLearnedAvg: "Inlärda i snitt",
    ...
    examinersHelp:
      "En examinator får redigera innehåll, se statistik och felrapporter för det här decket, men inte andra deck. Personen måste ha registrerat ett konto först.",
    examinerEmail: "E-postadress till ett registrerat konto",
    addExaminer: "Lägg till",
    removeExaminer: "Ta bort",
    examinerNotFound: "Inget konto med den adressen. Personen behöver registrera sig på kuggfri.com först.",
    ...
    contentHelp: "Kategorier och kort i den ordning studenterna ser dem.",
