...
polära bindningar
  - Svaga
  - Mellan polymerkedjor$kuggfri$, null, 1, true, $kuggfri$cc1eefb0f$kuggfri$);
...
keramens smälttemperatur$kuggfri$, null, 3, true, $kuggfri$c40f791c6$kuggfri$);
...
* Kan maskinbearbetas:
borrning, svarvning, fräsning$kuggfri$, null, 4, true, $kuggfri$c94914915$kuggfri$);
...
* Elektriskt och termiskt
isolerande
* Enkla att forma$kuggfri$, null, 5, true, $kuggfri$c10350f73$kuggfri$);
...
polymerkedjor
  - Kan inte formas med värme
  - Inte återvinningsbara$kuggfri$, null, 6, true, $kuggfri$cfaff89ba$kuggfri$);
...
* Andra exempel:
  ...
  - Hårdmetall = Co och WC$kuggfri$, null, 7, true, $kuggfri$cd0ffde95$kuggfri$);
...
* Sekundär formning
* Fogning
* Ytbehandling$kuggfri$, null, 8, true, $kuggfri$c54d63d8e$kuggfri$);
...
* Termiska egenskaper
* Kemiska egenskaper
* Miljö$kuggfri$, null, 9, true, $kuggfri$ca5fab47c$kuggfri$);
...
går sönder.$kuggfri$, null, 10, true, $kuggfri$ca3586415$kuggfri$);
...
elektronerna i materialet$kuggfri$, null, 11, true, $kuggfri$cc7f15811$kuggfri$);
...
* Termisk utvidgning$kuggfri$, null, 12, true, $kuggfri$c1ce5d22c$kuggfri$);
...
* Giftigt$kuggfri$, null, 13, true, $kuggfri$c9cbf661e$kuggfri$);
...
produkttillverkning,
användning och skrotning$kuggfri$, null, 14, true, $kuggfri$cef7e4e88$kuggfri$);
...
3. Rangordna
4. Sök dokumentation
5. Iterera$kuggfri$, null, 15, true, $kuggfri$c08dce506$kuggfri$);
...
* Amorf = oordnad struktur
  - Polymerer, glas$kuggfri$, null, 21, true, $kuggfri$caeb32e2d$kuggfri$);
...
Ex: FCC (Face Centered Cubic), BCC (Body Centered Cubic), Triclinic, Simple Cubic, Close-Packed Hexagonal.$kuggfri$, null, 22, true, $kuggfri$c058f867a$kuggfri$);
...
* Tätpackad ytdiagonal$kuggfri$, null, 23, true, $kuggfri$c20865935$kuggfri$);
...
* Ex: Fe
* Kantlängd a, vinkel 90 grader
* Tätpackad rymddiagonal$kuggfri$, null, 24, true, $kuggfri$cdb90fcb6$kuggfri$);
...
* Avgör om små atomer
kan lösas in i
materialet (ex. C i Fe)$kuggfri$, null, 25, true, $kuggfri$c87dc800f$kuggfri$);
...
\<hkl> = familj av riktningar$kuggfri$, null, 26, true, $kuggfri$c73f7a448$kuggfri$);
...
* Densiteten i polymerskum, trä m.m blir låg p.g.a. hålrummen.$kuggfri$, null, 27, true, $kuggfri$cd1d7839d$kuggfri$);
...
* Djup bindningsenergikurva ger:
  - Stor E-modul
  - Hög smälttemperatur$kuggfri$, null, 28, true, $kuggfri$c2c94427e$kuggfri$);
...
* Kan ej förändras med processer$kuggfri$, null, 29, true, $kuggfri$c5baa3cef$kuggfri$);
...
där brott sker
* Keramer, glas$kuggfri$, null, 30, true, $kuggfri$c8a7f6c32$kuggfri$);
...
området
* Metaller, polymerer$kuggfri$, null, 31, true, $kuggfri$c40238057$kuggfri$);
...
* Seghet – arean under dragprovkurvan$kuggfri$, null, 32, true, $kuggfri$c3ede6d52$kuggfri$);
...
Ex: Fiberriktning$kuggfri$, null, 33, true, $kuggfri$c3ae2700b$kuggfri$);
...
Fukt m.m.$kuggfri$, null, 34, true, $kuggfri$caaf94ae2$kuggfri$);
...
kompositer, trä → anisotropt material$kuggfri$, null, 35, true, $kuggfri$cec195120$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('7c7811c1-f9b4-53d9-b8cf-7f11fbb36aaa', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', '7b4bdbf7-ac7f-5d46-8266-31205b083f96', $kuggfri$vad-har-lastfall-for-inverkan-pa$kuggfri$, $kuggfri$Vad har lastfall för inverkan på materialindexet?$kuggfri$, $kuggfri$Lastfallet bestämmer vilket materialindex som är bäst lämpat för situationen. Materialindexet beskriver i sin tur hur bra ett material presterar i det aktuella lastfallet och kan därför med fördel användas för att rangordna en mängd material.$kuggfri$, null, 36, true, $kuggfri$cd8a28979$kuggfri$);
...
* För att få den mest rättvisa jämförelsen av materialindex bör man använda lastfallet som förekommer oftast!$kuggfri$, null, 37, true, $kuggfri$c0b956c78$kuggfri$);
...
översättningen
* Materialindex används för att rangordna material i materialvalet$kuggfri$, null, 38, true, $kuggfri$cfe887c54$kuggfri$);
...
last
* Kopplar till
sträckgräns$kuggfri$, null, 39, true, $kuggfri$cb7f1453a$kuggfri$);
...
* Dislokationer = extra
atomplan
* Korngränser$kuggfri$, null, 40, true, $kuggfri$c54afc7e4$kuggfri$);
...
band av plasticerat material$kuggfri$, null, 41, true, $kuggfri$c4b052634$kuggfri$);
...
4. Korngränshärdning$kuggfri$, null, 42, true, $kuggfri$c806855a0$kuggfri$);
...
atomstorlek
* Sker med legering i smälta$kuggfri$, null, 43, true, $kuggfri$cb7b5dd23$kuggfri$);
...
fast form$kuggfri$, null, 44, true, $kuggfri$c38d0adc3$kuggfri$);
...
(pressning, valsning, smide ...)$kuggfri$, null, 45, true, $kuggfri$c43037970$kuggfri$);
...
stål)$kuggfri$, null, 46, true, $kuggfri$c35cfcb48$kuggfri$);
...
spänning)$kuggfri$, null, 47, true, $kuggfri$ce07c86a0$kuggfri$);
...
(omslag mellan sprött och segt beteende)$kuggfri$, null, 52, true, $kuggfri$cbf60e6eb$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('21ec6dcd-d6ff-57d5-83b7-8f9c9e551096', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', '86266117-7fc7-5ca1-b416-41853cb7dbce', $kuggfri$vad-utgor-stal$kuggfri$, $kuggfri$Vad utgör stål?$kuggfri$, $kuggfri$Stål är järn legerat med kol som beroende på kolhalt och tillverkningsförhållanden kan ges olika egenskaper.$kuggfri$, null, 53, true, $kuggfri$c83aea5fa$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('37e85615-60cb-5f0b-aad8-3c081af15a0f', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', '86266117-7fc7-5ca1-b416-41853cb7dbce', $kuggfri$vad-ar-ett-fasdiagram-och-vad-anvands$kuggfri$, $kuggfri$Vad är ett fasdiagram och vad används det till?$kuggfri$, $kuggfri$Ett fasdiagram visar vilka faser som är stabila vid vilka specifika temperaturer och sammansättningar av de ingående metallerna i en legering (även tryck m.m.). Gäller vid långsamma förlopp så att utjämning av koncentrationsskillnader kan ske m.h.a. diffusion = jämvikt uppnås.$kuggfri$, null, 54, true, $kuggfri$c3b9b5d19$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('b7f718c4-fd46-589a-b120-4292ac949dfc', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', '86266117-7fc7-5ca1-b416-41853cb7dbce', $kuggfri$vad-ar-ferrit-och-nar-uppstar-det$kuggfri$, $kuggfri$Vad är Ferrit och när uppstår det?$kuggfri$, $kuggfri$Ferrit är rent järn upp till 910°C, BCC, låg löslighet av C.$kuggfri$, null, 55, true, $kuggfri$c3ad397b8$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('b75e3374-5e46-5d9c-8da7-6108d70dec27', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', '86266117-7fc7-5ca1-b416-41853cb7dbce', $kuggfri$vad-ar-austenit-och-nar-uppstar-det$kuggfri$, $kuggfri$Vad är Austenit och när uppstår det?$kuggfri$, $kuggfri$Austenit, rent järn upp över 910 °C, FCC, upp till 2.1 % löslighet av C.$kuggfri$, null, 56, true, $kuggfri$c5a11508e$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('98158a2f-4921-5d45-87ce-a327352ae79f', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', '86266117-7fc7-5ca1-b416-41853cb7dbce', $kuggfri$vad-ar-cementit-och-nar-uppstar-det$kuggfri$, $kuggfri$Vad är cementit och när uppstår det?$kuggfri$, $kuggfri$Cementit, Fe₃C, intermediär fas, 6,67 % C, mycket hård$kuggfri$, null, 57, true, $kuggfri$c93bf3850$kuggfri$);
...
Maskinstål kan härdas och är legerat för att öka härdbarheten. Dock är det svårare att svetsa än exempelvis konstruktionsstål. Exempel på användningsområden är järnvägsräls, handverktyg, maskindelar etc.$kuggfri$, null, 64, true, $kuggfri$c6e73d035$kuggfri$);
...
Verktygsstål är legerat för att erhålla stabila karbider vid hög temperatur. Används i exempelvis gjutformar, pressverktyg, skärverktyg och kullager.$kuggfri$, null, 65, true, $kuggfri$c79e136d0$kuggfri$);
...
* Tre typer: ferritiska (billiga), austenitiska (bäst korrosionsmotstånd, lågtemperaturegenskaper), martensitiska (kan härdas)$kuggfri$, null, 66, true, $kuggfri$c06bc9015$kuggfri$);
...
(deformationshärdning)$kuggfri$, null, 67, true, $kuggfri$cdbfb0930$kuggfri$);
...
* Förbättra materialets struktur – den får en jämnare och mer homogen kornstruktur.$kuggfri$, null, 68, true, $kuggfri$c77e292da$kuggfri$);
...
* Stora deformationer är möjliga$kuggfri$, null, 69, true, $kuggfri$c984131de$kuggfri$);
...
* Kalldeformation: Låg temperatur, spänningar och hårdhet ökar, materialet blir starkare men samtidigt sprödare.$kuggfri$, null, 70, true, $kuggfri$cd803b7a3$kuggfri$);
...
* Valsning
* Pressning
* Tråddragning$kuggfri$, null, 71, true, $kuggfri$c06e8c551$kuggfri$);
...
(högt och lågt tryck)
* Sandgjutning
* Lost wax- casting$kuggfri$, null, 72, true, $kuggfri$c0e5aff93$kuggfri$);
...
Ex: TIG/MIG/MAG$kuggfri$, null, 73, true, $kuggfri$c923a365d$kuggfri$);
...
* Fasomvandlingar
* Kemiska reaktioner$kuggfri$, null, 74, true, $kuggfri$c39b424e6$kuggfri$);
...
glasomvandlingstemperaturen "Tg".$kuggfri$, null, 75, true, $kuggfri$cd10f73a9$kuggfri$);
...
Detta resulterar sammantaget i "Termisk utmattning" över tid.$kuggfri$, null, 78, true, $kuggfri$c087e8e7f$kuggfri$);
...
Svaga atombindningar ger stor termisk utvidgning och eftersom styrkan hos atombindningarna beror på temperaturen gör också den termiska utvidningskoefficienten det!$kuggfri$, null, 79, true, $kuggfri$c6dad1180$kuggfri$);
...
fononerna → lägre
värmeledningsförmåga$kuggfri$, null, 80, true, $kuggfri$c10fd4c2a$kuggfri$);
...
Beräkningen av värmeflöde och värmeledning tillhör området "Termodynamik" och är inget vi har gått närmare in på i kursen.$kuggfri$, null, 81, true, $kuggfri$c15448486$kuggfri$);
...
kristall$kuggfri$, null, 82, true, $kuggfri$c6a88abe5$kuggfri$);
...
Man får en uppsättning partiella differentialekvationer som bäst löses numeriskt.$kuggfri$, null, 83, true, $kuggfri$cd9abefa7$kuggfri$);
...
* Spänningen kan ändra krypmekanism$kuggfri$, null, 84, true, $kuggfri$c4f0e6d20$kuggfri$);
...
m.h.a. diffusion
* Kornen förlängs i
belastningsriktningen$kuggfri$, null, 85, true, $kuggfri$c32662773$kuggfri$);
...
komma runt hinder$kuggfri$, null, 86, true, $kuggfri$c12f8edc5$kuggfri$);
...
till brott till följd av krypning.$kuggfri$, null, 87, true, $kuggfri$cf7f600fe$kuggfri$);
...
* CO₂ används som mått på miljöbelastning (carbon footprint)$kuggfri$, null, 88, true, $kuggfri$cf98c22ba$kuggfri$);
...
legeringar
* Skrotet måste samlas in, transporteras, sorteras$kuggfri$, null, 89, true, $kuggfri$c7090f70e$kuggfri$);
...
* Förorenas av Fe → Blandat skrot kan bara användas i begränsade mängder för återvinning till smideslegeringar.$kuggfri$, null, 90, true, $kuggfri$cc03aaea1$kuggfri$);
...
* Bra korrosionsmotstånd och livslängd. Bör återvinnas.$kuggfri$, null, 91, true, $kuggfri$c35ac4ed9$kuggfri$);
...
* Sorterat skrott är mer användbart och har högre värde$kuggfri$, null, 92, true, $kuggfri$c79f41e45$kuggfri$);
...
- Transport, värmning, processer$kuggfri$, null, 93, true, $kuggfri$c4d18d0c9$kuggfri$);
...
jordartsmetaller, platina-gruppen, fissionsämne (U, Th, Pu), W, Ta, Nb, Ga, In$kuggfri$, null, 94, true, $kuggfri$cf07cfe21$kuggfri$);
...
livscykeln$kuggfri$, null, 95, true, $kuggfri$c8982c186$kuggfri$);
...
* Varmvalsning
* Kallbearbetning
* Kallvalsning, tråddragning, m.m. → plåt, räls, balkar, stång, tråd$kuggfri$, null, 96, true, $kuggfri$c2d92760d$kuggfri$);
...
Kolhalten avgör andelen cementit. Temperatur och tid för anlöpningen avgör storleken på cementitpartiklarna. Används när hårdhet och sträckgräns är viktigt.$kuggfri$, null, 97, true, $kuggfri$c83842405$kuggfri$);
...
* Förbättra härdbarheten – Legeringar med ämnen som krom och molybden ökar stålets förmåga att härdas djupt, vilket gör att materialet får en jämn hårdhet vid härdning.$kuggfri$, null, 98, true, $kuggfri$c38f27e43$kuggfri$);
...
skyddande oxidskikt på ytan$kuggfri$, null, 99, true, $kuggfri$c59d708db$kuggfri$);
...
* Energikrävande produktion$kuggfri$, null, 100, true, $kuggfri$ccedbc339$kuggfri$);
...
negativ för kroppen)$kuggfri$, null, 101, true, $kuggfri$c639a5dce$kuggfri$);
...
* Lagerbrons har bra tribologiska egenskaper$kuggfri$, null, 102, true, $kuggfri$c7ee297a6$kuggfri$);
...
Zr, Fe, Hf$kuggfri$, null, 103, true, $kuggfri$c2cab480f$kuggfri$);
...
Stål är bra, men i vissa situationer väljs andra material för att deras speciella egenskaper gör de särskilt fördelaktiga.$kuggfri$, null, 104, true, $kuggfri$cd5fbed9a$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('35410586-b689-51cf-b5f3-b1f791bf2152', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', 'bfff339c-3a73-562e-b919-e03c3b7521e8', $kuggfri$aldring$kuggfri$, $kuggfri$Åldring$kuggfri$, $kuggfri$Åldring av metaller (eller åldringshärdning) är en process där metallens mikrostruktur och egenskaper förändras över tid, antingen genom naturlig åldring vid rumstemperatur eller genom en kontrollerad värmebehandling som kallas artificiell åldring. Åldring används ofta för att förbättra mekaniska egenskaper som hårdhet och hållfasthet i metallegeringar, särskilt aluminium-, titan- och nickelbaserade legeringar.$kuggfri$, null, 105, true, $kuggfri$ca7c35780$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('4a90b17b-5925-5e27-9d4a-1c775d3725af', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', 'bfff339c-3a73-562e-b919-e03c3b7521e8', $kuggfri$brottforlangning$kuggfri$, $kuggfri$Brottförlängning$kuggfri$, $kuggfri$Den plastiska förlängningen som kvarstår efter ett material har belastats till brott.$kuggfri$, null, 106, true, $kuggfri$c523bfaa1$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('0d934389-0908-50df-8ec9-5474b9faa25d', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', 'bfff339c-3a73-562e-b919-e03c3b7521e8', $kuggfri$keram$kuggfri$, $kuggfri$Keram$kuggfri$, $kuggfri$Ett material som är uppbyggt av en metall och en icke-metall (minst).$kuggfri$, null, 107, true, $kuggfri$cb8e8f5ec$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('6a417f80-0c34-5ad4-89f5-90a0c4e7963c', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', 'bfff339c-3a73-562e-b919-e03c3b7521e8', $kuggfri$co-foot-print$kuggfri$, $kuggfri$CO₂-foot print$kuggfri$, $kuggfri$Den mängd CO₂ som bildas vid produktion av ett kilo material.$kuggfri$, null, 108, true, $kuggfri$cea26b918$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('fa1984b2-f558-570c-a331-a604f2b4d29c', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', 'bfff339c-3a73-562e-b919-e03c3b7521e8', $kuggfri$anisotropt$kuggfri$, $kuggfri$Anisotropt$kuggfri$, $kuggfri$Olika egenskaper i olika riktningar$kuggfri$, null, 109, true, $kuggfri$caeff55e9$kuggfri$);
...
temperatur.$kuggfri$, null, 110, true, $kuggfri$cc0a6de93$kuggfri$);
...
temperaturen.$kuggfri$, null, 111, true, $kuggfri$cdf5b22b9$kuggfri$);
...
spricka. Brott fås när spänningsintensiteten vid sprickspetsen är högre än brottsegheten.$kuggfri$, null, 112, true, $kuggfri$cbd96ed6c$kuggfri$);
...
vid sprickspetsen, vilket ger ett stort antal cykler till brott.$kuggfri$, null, 113, true, $kuggfri$cda61b989$kuggfri$);
...
ske, t.ex. kemiska reaktioner, diffusion, krypning.$kuggfri$, null, 114, true, $kuggfri$c0dfd4a93$kuggfri$);
...
och koncentration genom en trefasreaktion där en smält fas L bildar två fasta faser: L → alpha + beta$kuggfri$, null, 122, true, $kuggfri$c24163509$kuggfri$);
...
något sätt. Kan vara en fas, eutektikum eller eutektoid.$kuggfri$, null, 141, true, $kuggfri$cb418c575$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('2966162f-6239-561d-997b-f65d8642ef18', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', 'bfff339c-3a73-562e-b919-e03c3b7521e8', $kuggfri$fas$kuggfri$, $kuggfri$Fas$kuggfri$, $kuggfri$En del av materialet med homogena fysikaliska och kemiska egenskaper$kuggfri$, null, 142, true, $kuggfri$c4897e06a$kuggfri$);
insert into public.cards (id, deck_id, category_id, key, front, back, hint, sort_order, is_active, source_hash) values ('22b91be4-1d32-5d02-b3ec-d2f57e5208a0', '1fd9bb0d-b779-540f-bbbd-604e02cdaf6b', 'bfff339c-3a73-562e-b919-e03c3b7521e8', $kuggfri$superlegering$kuggfri$, $kuggfri$Superlegering$kuggfri$, $kuggfri$Vanligtvis legeringar med Ni-bas som har excellenta högtemperaturegenskaper, oxidations- och korrosionsmotstånd.$kuggfri$, null, 143, true, $kuggfri$c5ecea5eb$kuggfri$);
